          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
              <h3 className="font-semibold text-slate-800 mb-4 flex items-center">
                <Plane size={20} className="mr-2 text-slate-500" /> Recent
                Outbound Manifests (From {currentLocation})
              </h3>
                ...
                <>
                  ...
                  <div className="mb-6">
                    <h4 className="font-bold text-slate-700 flex items-center mb-3">
                      <Calculator size={18} className="mr-2 text-slate-500" />{" "}
                      URA Tax Assessment
                    </h4>
                    ...
                    {activeDeconMawb.taxStatus === TaxStatus.UNASSESSED && (
                      <div className="bg-slate-50 p-6 rounded border border-slate-200 text-center">
                        <p className="text-slate-600 mb-4">
                          Tax assessment has not been generated for this
                          manifest.
                        </p>
                        <button
