    ...
    <div className="space-y-6">
       <div className="flex items-center justify-between bg-white p-4 rounded-lg shadow-sm border border-slate-200">
          <div className="flex items-center space-x-4">
             ...
             <div>
                <h2 className="text-xl font-bold text-slate-800">Where is my order? <span className="text-sm font-normal text-slate-500 ml-2">#{id}</span></h2>
           ...
           <div className="flex-1 overflow-y-auto p-6 space-y-6">
               <div className="flex gap-4">
                   ...
                   <div>
                       <div className="flex items-baseline mb-1">
                           <span className="font-bold text-slate-800 mr-2">John Doe</span>
                           <span className="text-xs text-slate-400">Today, 10:00 AM</span>
                       </div>
                       <div className="bg-slate-100 p-4 rounded-r-lg rounded-bl-lg text-slate-800 text-sm max-w-lg">
               ...
               <div className="flex gap-4 flex-row-reverse">
                   ...
                   <div className="text-right">
                       ...
                       <div className="bg-blue-600 p-4 rounded-l-lg rounded-br-lg text-white text-sm max-w-lg text-left">
